...
//	ret = snd_soc_dai_set_clkdiv(&wm8960_dai,
//					WM8960_SYSCLKSEL, WM8960_SYSCLK_MCLK);
//	if (ret < 0)
//		return ret;
//
//	/* Explicitly set WM8960-ADC to source from MCLK */
//	ret = snd_soc_dai_set_clkdiv(&wm8960_dai,
//				WM8960_ADC_CLKSEL, WM8960_CLKSRC_ADCMCLK);
//	if (ret < 0)
//		return ret;
...
//		return ret;
//
//	/* Explicitly set WM8960-DAC to source from MCLK */
//	ret = snd_soc_dai_set_clkdiv(&wm8960_dai,
//				WM8960_DAC_CLKSEL, WM8960_CLKSRC_MCLK);
//	if (ret < 0)
//		return ret;
...
/*
 * SMDK64XX WM8960 DAI operations.
 */
