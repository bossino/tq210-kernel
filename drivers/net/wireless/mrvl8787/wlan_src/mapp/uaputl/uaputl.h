...
#define DEFAULT_MAX_VALID_CHANNLEL_BG 11
...
/** TLV : Pairwise Cipher */
#define MRVL_CIPHER_PWK_TLV_ID            (PROPRIETARY_TLV_BASE_ID + 145)
/** TLV : Group Cipher */
#define MRVL_CIPHER_GWK_TLV_ID            (PROPRIETARY_TLV_BASE_ID + 146)
/** TLV : BSS Status */
#define MRVL_BSS_STATUS_TLV_ID            (PROPRIETARY_TLV_BASE_ID + 147)

/** TLV: HT_CAPABILITY */
#define HT_CAPABILITY_TLV_ID                   45
...
#define VENDOR_SPECIFIC_IE_TLV_ID      221
...
int check_channel_validity_11d(int channel);
