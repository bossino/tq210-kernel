...
#define	PRINTM_INFO(msg...)  do {if (drvdbg & DBG_INFO)  printk( msg);} while(0)
/** Print warning message */
#define	PRINTM_WARN(msg...)  do {if (drvdbg & DBG_WARN)  printk( msg);} while(0)
/** Print entry message */
#define	PRINTM_ENTRY(msg...) do {if (drvdbg & DBG_ENTRY) printk( msg);} while(0)
#else
/** Print informative message */
...
#define	PRINTM_INTR(msg...)  do {if (drvdbg & DBG_INTR)  printk( msg);} while(0)
/** Print event message */
#define	PRINTM_EVENT(msg...) do {if (drvdbg & DBG_EVENT) printk( msg);} while(0)
/** Print command message */
#define	PRINTM_CMD(msg...)   do {if (drvdbg & DBG_CMD)   printk( msg);} while(0)
/** Print data message */
#define	PRINTM_DATA(msg...)  do {if (drvdbg & DBG_DATA)  printk( msg);} while(0)
/** Print error message */
#define	PRINTM_ERROR(msg...) do {if (drvdbg & DBG_ERROR) printk( msg);} while(0)
/** Print fatal message */
#define	PRINTM_FATAL(msg...) do {if (drvdbg & DBG_FATAL) printk( msg);} while(0)
/** Print message */
#define	PRINTM_MSG(msg...)   do {if (drvdbg & DBG_MSG)   printk( msg);} while(0)

/** Print data dump message */
#define	PRINTM_DAT_D(msg...)  do {if (drvdbg & DBG_DAT_D)  printk( msg);} while(0)
/** Print data dump message */
#define	PRINTM_CMD_D(msg...)  do {if (drvdbg & DBG_CMD_D)  printk( msg);} while(0)
