...
#if 0
	uint8_t config_info[] = {
	0x65,0x01,(TOUCH_MAX_HEIGHT>>8),(TOUCH_MAX_HEIGHT&0xff),
	(TOUCH_MAX_WIDTH>>8),(TOUCH_MAX_WIDTH&0xff),MAX_FINGER_NUM,0x61,//(0x2C | INT_TRIGGER),
	0x01,0x0,0x0f,0x20,0x02,0x8,0x10,0x00,
	0x00,0x20,0x00,0x00,0x88,0x10,0x10,0x0,0x37,0x00,0x00,0x0b,0x0a,0x09,0x08,0x07,
	0x06,0x05,0x04,0x03,0x02,0x1,0x00,0xff,0xff,0xff,0xff,0xb,0xa,0x9,0x8,0x7,
	0x6,0x5,0x4,0x3,0x2,0x1,0x00,0xff,0xff,0xff,0xff,0x00,0x00,0x3c,0x64,0x64,
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00
	};
#endif
...
//	printk("======================================================================================");
//	i2c_read_bytes(ts->client,config_info, (sizeof(config_info)/sizeof(config_info[0])));
