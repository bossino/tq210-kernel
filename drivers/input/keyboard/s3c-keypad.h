...
#elif defined(CONFIG_KEYPAD_S3C_DEVBOARD)
#define KEYPAD_COLUMNS	3
#define KEYPAD_ROWS	4
#define MAX_KEYPAD_NR	12  /* 3*4 */
#define MAX_KEYMASK_NR	6
#else
#define KEYPAD_COLUMNS	8
...
#define VOLUME_UP     42
#define VOLUME_DOWN   58
#define MENU          50
#define ENDCALL       26
#define BACK          34
#define DPAD_LEFT     57
#define DPAD_RIGHT    49
#define DPAD_UP       25
#define DPAD_DOWN     41
#define DPAD_CENTER   33
#define POWER         10
#define UNKNOWN       11

char keypad_str[MAX_KEYPAD_NR][16] = {"DPAD_LEFT  ", "DPAD_DOWN  ", "DPAD_UP    ", "DPAD_RIGHT ", "DPAD_CENTER", "BACK       ", 
                                      "VOLUME_UP  ", "VOLUME_DOWN", "POWER      ", "MENU       ", "ENDCALL    ", "UNKNOWN    "};

int keypad_keycode[MAX_KEYPAD_NR] = {
	DPAD_LEFT,   DPAD_DOWN, DPAD_UP,   DPAD_RIGHT, 
	DPAD_CENTER, BACK,      VOLUME_UP, VOLUME_DOWN, 
	POWER,       MENU,      ENDCALL,   UNKNOWN
};
#else
int keypad_keycode[] = {
	1, 2, 3, 4, 5, 6, 7, 8,
