...
#define S3C_RNDIS_ADB_PRODUCT_ID	0x4E26
...
static char device_serial[MAX_USB_SERIAL_NUM] = "S5PV210-DevBoard";
#elif defined (CONFIG_S5PV210_A8388_V1)
static char device_serial[MAX_USB_SERIAL_NUM] = "A8388-V1";
#elif defined (CONFIG_S5PV210_A8388_V2)
static char device_serial[MAX_USB_SERIAL_NUM] = "A8388-V2";
#elif defined(CONFIG_S5PV210_S9)
static char device_serial[MAX_USB_SERIAL_NUM] = "S9";
#elif defined(CONFIG_S5PV210_A9)
static char device_serial[MAX_USB_SERIAL_NUM] = "A9";
#else
